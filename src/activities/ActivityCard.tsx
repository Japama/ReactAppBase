...
function ActivityCard(props: ActivityCardProps) {
    ...
    return (
        // <div>
            <div className="px-4 bg-white mb-8 py-8 rounded-3xl mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 shadow-xl hover:scale-95 cursor-pointer hover:duration-1000">
