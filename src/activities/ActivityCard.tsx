...
function ActivityCard(props: ActivityCardProps) {
    ...
    return (
        <div>
            <section className="transform bg-white dark:bg-gray-900 shadow-md hover:scale-105 hover:shadow-2xl cursor-pointer hover:duration-1000 rounded-3xl mx-20 hover:transition-all">
                <div className="lg:grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="inline-flex items-end justify-between max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 mx-2">Categría: {activity.category}</p>
                    ...
                    <div className='inline-flex mt-2'>
                        ...
                        <div className="flex flex-wrap lg:flex-nowrap ml-4">
                            {activity.tags.map((tag) => (
                                <p key={activity._id + tag} className="w-1/2 md:w-1/3 max-w-2xl font-light text-gray-500 md:text-lg lg:text-xl dark:text-gray-400 ml-2">#{tag}</p>
                            ))}
                        </div>
                    </div>
                </div>
